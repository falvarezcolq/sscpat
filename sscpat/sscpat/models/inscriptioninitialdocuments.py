...
class InscriptionInitialDocument(SSCPATModel):

    """Academic Project models.
    list academic projects
    """

    inscription = models.ForeignKey(Inscription, on_delete=models.CASCADE, verbose_name="inscriptions",related_name="initialdocuments")
