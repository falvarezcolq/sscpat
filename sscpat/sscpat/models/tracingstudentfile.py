...
class TracingStudentFile(SSCPATModel):

    """Academic Project models.
    list academic projects
    """

    tracingstudent = models.ForeignKey( TracingStudent, on_delete=models.CASCADE, verbose_name="inscriptions" ,related_name="files")
    title = models.CharField(_("title") ,max_length=255,blank=True,default="")
    format = models.CharField(_("format"),max_length=32)
    path =  models.FileField(_("file path"),upload_to="tracing_student_file/")
    ...
    def save(self, *args, **kwargs):
        ...
        return super(TracingStudentFile, self).save(*args, **kwargs)