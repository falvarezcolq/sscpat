...
class Config{
    ...
    static SearchTutorApiUrl = HOST + "/api/search/tutor/"
    static SearchStudentApiUrl = HOST + "/api/search/student/"
    ...
    static aProjectsDatesUrl                ="/proyectos/fechas/historial/";
    static aProjectsDatesIdUrl              ="/proyectos/fechas/historial/:id";
