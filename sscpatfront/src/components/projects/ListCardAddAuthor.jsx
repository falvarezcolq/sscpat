                            ...
                            <tbody>
                              {projects.results.map((project) => (
                                <tr key={project.id}>
                                  ...
                                  <td>
                                    <button className="btn btn-default">Agregar autor</button>
                                  </td>
                                </tr>
                              ))}
                            </tbody>
...
export default connect(mapStateToProps, mapDispatchToProps)(ListCardAddAuthor);
